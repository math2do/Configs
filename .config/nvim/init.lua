...
vim.o.ttimeoutlen = 0 -- Time to wait for a key code sequence to complete (in milliseconds) (default: 1000)
...
-- window management
-- Resize with arrows
-- Following don't work because arrow keys are disabled
...
vim.keymap.set('n', '<leader>xw', ':close<CR>', opts) -- close current split window
			...
			local servers = {
				...
				yamlfmt = {
					settings = {
						yaml = {
							schemas = {
								-- Use the official Ansible Playbook schema for all .yml/.yaml files
	...
	{ -- Autoformat
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				-- WARN: below was not empty initially
